"""The inter-member message envelope — a routed, multi-recipient mailbox item."""
...
from grasp_agents.types.packet import Packet, PacketRouting

# Sender name stamped on the initial input the team seeds into the entry
# member's mailbox (members address each other by name; "user" is the human).
USER_SENDER = "user"
