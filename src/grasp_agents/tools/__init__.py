...
``FileToolkit`` is imported lazily (PEP 562) so importing :mod:`grasp_agents.tools`
doesn't pull in the file tools (and their ripgrep-availability checks) eagerly.
"""
